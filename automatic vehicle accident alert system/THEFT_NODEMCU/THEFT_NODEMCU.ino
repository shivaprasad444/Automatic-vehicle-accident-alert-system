...
const char* ssid     = "MLRITM-PLACEMENT";//Enter the ssid of your router
const char* password = "Mlritm@123";//Enter the password of your router
...
void Sensor_Data()
{
  ...
  if ( State == 0){
  url1="/api/sendhttp.php?mobiles=8008795449&authkey=282211AgHyIyq1REzu5d0dff9d&route=4&sender=TESTIN&message=NEED ACCESS&country=91";
   msgurl = url1;
  msggg();
  }
  delay(1000);  
...
const String privateKey = "Y93DUNPL1V9QBDKV";
...
void msg91(){
url1="/api/sendhttp.php?mobiles=8008795449&authkey=282211AgHyIyq1REzu5d0dff9d&route=4&sender=TESTIN&message=HELLO BOSS&country=91";
 msgurl = url1;
